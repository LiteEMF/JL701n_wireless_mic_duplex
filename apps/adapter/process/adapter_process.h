...
enum adapter_event {
    ...
    ADAPTER_EVENT_MEDIA_DECODE_ERR,
    ADAPTER_EVENT_MEDIA_CLOSE,

    ADAPTER_EVENT_POWEROFF,
    ADAPTER_EVENT_SET_MUSIC_VOL,
    ADAPTER_EVENT_SET_MIC_VOL,
    ADAPTER_EVENT_SET_PAIR,
    ADAPTER_EVENT_CONNECT,
    ADAPTER_EVENT_DISCONN,
};
