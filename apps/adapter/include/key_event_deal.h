...
///旋钮按键
    ...
    //无线麦事件
    KEY_WIRELESS_MIC_DENOISE_SET,//降噪设置
    KEY_WIRELESS_MIC_DENOISE_SYNC,//降噪等级同步
    KEY_WIRELESS_MIC_ECHO_SET,//混响seting
    KEY_WIRELESS_MIC_ECHO_SYNC,//混响同步
    KEY_ENTER_PAIR,//1tn 进入配对模式
    KEY_EXIT_PAIR,//1tn 退出配对模式
    KEY_WIRELESS_MIC_CH_SW,//2t1通道切换
    KEY_SW_SAMETIME_OUTPUT,//开关同时输出到dac
    KEY_MODE_SW,//模式切换
    KEY_RECORD_SW,	//开关录音
    KEY_WIRELESS_2t1_RX_SEND_DATA,//两发一收rx发送数据
