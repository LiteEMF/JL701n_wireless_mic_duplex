...
static const struct conn_update_param_t connection_param_table[] = {
    {WIRELESS_BLE_CONNECT_INTERVAL, WIRELESS_BLE_CONNECT_INTERVAL, 0, 200},//11
};
...
extern void wlm_tx_conn_init(const void *param, void *app_rx_cbk, void *reinit_server_work_state);
static wlm_param tx_param = {
    .pair_name = MATCH_NAME,
    .param = {
#if (WIRELESS_24G_ENABLE)
        [0] = WIRELESS_24G_CODE_ID & 0xff,
        [1] = (WIRELESS_24G_CODE_ID >> 8) & 0xff,
        [2] = (WIRELESS_24G_CODE_ID >> 16) & 0xff,
        [3] = (WIRELESS_24G_CODE_ID >> 24) & 0xff,
#endif
    },
};

static void wlm_tx_testbox_conn_timeout(void)
{
#if (WIRELESS_24G_ENABLE)
...
void bt_ble_init(void)
{
    ...
    memset(gap_device_name, 0, config_name_len + 1);
