...
/*
 *-------------------LE Vendor power control
 */
#define LE_VPWRCTRL_IS_SUPPORT()            (config_force_bt_pwr_tab_using_normal_level == 0x100)
#define LE_VPWRCTRL_IS_SUPPORT_OPTIMIZE()   if (!LE_VPWRCTRL_IS_SUPPORT())   return
